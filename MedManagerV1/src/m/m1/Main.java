...
public class Main {
 ...
 static void modifierPatient(Scanner sc) {
     ...
     do {
         ...
         System.out.println("3. Date de naissance [" + patient.getDateNaissance() + "]");
         System.out.println("4. Téléphone [" + patient.getTelephone() + "]");
         System.out.println("5. Groupe sanguin [" + patient.getGroupeSanguin() + "]");
 ...
 static void affecterMedecinAuService(Scanner sc) {
     ...
     System.out.println("✅ " + medecin + " affecté au service " + services.get(idx).getNom());
 }
